...
export const showProjectSearch = [
  // bim
  { component: '/bim/model-show/index', type: allPT, required: true },
  ...
  { component: '/ship-manage/pack-and-ship/ship-list/index', type: pt.STEEL.V | pt.ENCLOSURE.V | pt.BRIDGE.V, required: true },
  { component: '/ship-manage/pack-and-ship/logistics-list/index', type: pt.STEEL.V | pt.ENCLOSURE.V | pt.BRIDGE.V, required: true },
  { component: '/ship-manage/pack-and-ship/pack-list/index', type: pt.STEEL.V | pt.ENCLOSURE.V | pt.BRIDGE.V, required: true },
  { component: '/ship-manage/pack-and-ship/receipt-status/index', type: pt.STEEL.V | pt.ENCLOSURE.V | pt.BRIDGE.V, required: true },
  { component: '/ship-manage/pack-and-ship/ship-audit/index', type: pt.STEEL.V | pt.ENCLOSURE.V | pt.BRIDGE.V, required: true },
  { component: '/ship-manage/pack-and-ship/product-send-receive-storage/structure/index', type: pt.STEEL.V, required: false },
  { component: '/ship-manage/pack-and-ship/product-send-receive-storage/enclosure/index', type: pt.ENCLOSURE.V, required: false },
  { component: '/ship-manage/pack-and-ship/product-send-receive-storage/box/index', type: pt.BRIDGE.V, required: false },
  // MES
  ...
  { component: '/enclosure/production-manage/change-approval/index', type: pt.STEEL.V | pt.ENCLOSURE.V, required: true }
]
