...
import { boxDetail, assembleDetail, machinePartDetail } from '@/api/bridge/production-order-manage/production-order'
...
async function fetchDetail() {
  ...
  try {
    const api = props.productType === componentTypeEnum.ARTIFACT.V ? boxDetail : (props.productType === componentTypeEnum.ASSEMBLE.V) ? assembleDetail : machinePartDetail
