<template>
  <div class="head-container">
    <project-header-time v-model="month" :data="timeList" @change="fetchTree" empty-text="暂无分段排产信息" />
    <!-- <el-date-picker
      v-model="month"
      type="month"
      size="small"
...
<script setup>
import { getProjectToAreaTree, getAreaTreeTime } from '@/api/bridge/scheduling-manage/box'
