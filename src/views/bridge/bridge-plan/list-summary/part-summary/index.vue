...
<script setup>
import crudApi from '@/api/bridge/bridge-plan/part-summary'
...
import { partSummaryListPM as permission } from '@/page-permission/bridge'
...
CRUD.HOOK.handleRefresh = (crud, data) => {
  data.data.content = data.data.content.map((v) => {
    v.productType = bridgeComponentTypeEnum.MACHINE_PART.V
