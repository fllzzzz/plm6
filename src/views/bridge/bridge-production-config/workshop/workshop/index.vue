...
<script setup>
import crudApi, { editStatus } from '@/api/config/bridge/workshop'
import { ref, defineProps, computed, watch, inject } from 'vue'
import { useStore } from 'vuex'
import { ElMessageBox } from 'element-plus'
import checkPermission from '@/utils/system/check-permission'
import { bridgeWorkshopPM as permission } from '@/page-permission/config'
...
function changeStoreLoaded() {
  store.commit('config/SET_LOADED', { key: 'bridgeWorkshops', loaded: false })
}
</script>
