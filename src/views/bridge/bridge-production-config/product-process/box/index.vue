<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="name" align="center" :show-overflow-tooltip="true" label="分段类型" min-width="200"></el-table-column>
      <el-table-column prop="specSequence" :show-overflow-tooltip="true" label="分段规格前缀索引" min-width="300"></el-table-column>
