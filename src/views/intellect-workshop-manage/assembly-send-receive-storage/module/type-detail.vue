  ...
  >
    ...
    <template #content>
      ...
      <common-table :data="list" v-loading="tableLoading" :data-format="dataFormat" show-summary :summary-method="getSummaries" :max-height="maxHeight" v-if="visible">
        ...
        <el-table-column key="typesettingAssembleType" prop="typesettingAssembleType" label="类型" align="center" />
...
import { assembleTypeEnum } from '@enum-ms/intellect-workshop'
...
const dataFormat = ref([
  ...
  ['typesettingAssembleType', ['parse-enum', assembleTypeEnum]]
])
