<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column v-if="columns.visible('state')" :show-overflow-tooltip="true" prop="state" label="状态" align="center">
      ...
      <el-table-column v-permission="permission.edit" label="操作" width="130px" align="center">
        <template v-slot="scope">
          <div>
            <udOperation :show-del="!scope.row.isSystem"  :show-edit="false" :data="scope.row" />
          </div>
        </template>
      </el-table-column>
    </common-table>
...
<script setup>
import crudApi from '@/api/config/main/unit-config'
import { ref } from 'vue'
