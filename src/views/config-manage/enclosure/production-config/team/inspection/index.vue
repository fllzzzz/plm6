...
<script setup>
import crudApi from '@/api/config/enclosure/production-config/inspection'
import { defineExpose, ref } from 'vue'
import { useStore } from 'vuex'

import checkPermission from '@/utils/system/check-permission'
import { enclosureConfigProductionLineInspectPM as permission } from '@/page-permission/config'
