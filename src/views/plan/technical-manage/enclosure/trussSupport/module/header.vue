...
const defaultQuery = {
  ...
  category: { value: TechnologyTypeEnum.ENUM.TRUSSFLOORPLATE.V, resetAble: false },
}
...
const carryParam = computed(() => {
  return { areaId: crud.query.areaId, category: TechnologyTypeEnum.ENUM.TRUSSFLOORPLATE.V }
})
