      ...
      >
        ...
        <el-table-column align="center" label="钢板信息">
          ...
          <el-table-column align="center" label="厚度">
            <template v-slot="scope">
              <div class="sandwich-cell-top">
                {{ scope.row.outboard.thickness ? scope.row.outboard.thickness.toFixed(DP.MES_ENCLOSURE_T__MM) : '-' }}
              </div>
              <div class="sandwich-cell-bottom">
                {{ scope.row.inboard.thickness ? scope.row.inboard.thickness.toFixed(DP.MES_ENCLOSURE_T__MM) : '-' }}
              </div>
            </template>
          </el-table-column>
          <el-table-column align="center" label="宽度">
            <template v-slot="scope">
              <div class="sandwich-cell-top">
                {{ scope.row.outboard.width ? scope.row.outboard.width.toFixed(DP.MES_ENCLOSURE_W__MM) : '-' }}
              </div>
              <div class="sandwich-cell-bottom">
                {{ scope.row.inboard.width ? scope.row.inboard.width.toFixed(DP.MES_ENCLOSURE_W__MM) : '-' }}
              </div>
            </template>
          </el-table-column>
