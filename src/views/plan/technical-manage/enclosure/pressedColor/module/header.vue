  ...
  <div>
    <div v-show="crud.searchToggle">
      <monomer-select
        ...
        class="filter-item"
        :productType="TechnologyTypeAllEnum.PROFILED_PLATE.V"
...
const defaultQuery = {
  ...
  category: { value: TechnologyTypeAllEnum.PROFILED_PLATE.V, resetAble: false }
}
...
const carryParam = computed(() => {
  return { areaId: crud.query.areaId, category: TechnologyTypeAllEnum.PROFILED_PLATE.V }
})
