...
const defaultQuery = {
  ...
  category: { value: TechnologyTypeEnum.ENUM.PRESSURE_BEARING_PLATE.V, resetAble: false }
}
...
const carryParam = computed(() => {
  return { areaId: crud.query.areaId, category: TechnologyTypeEnum.ENUM.PRESSURE_BEARING_PLATE.V }
})
