        ...
        v-permission="permission.print"
          :api-key="
            showType === 'INVENTORY'
              ...
              : showType === 'ASSIGNMENT'
              ? 'bridgeShipTaskMeteDetail'
              : showType === 'STORAGE'
              ? 'bridgeShipInboundMeteDetail'
              : showType === 'CUMULATIVE_SHIPMENT'
              ? 'bridgeShipTotalMeteDetail'
              : showType === 'SHIPMENT_MONTH'
              ? 'bridgeShipMonthMeteDetail'
              : showType === 'IN_STOCK'
              ? 'bridgeShipStockMeteDetail'
              : 'bridgeShipTrainMeteDetail'
          "
          :params="{
