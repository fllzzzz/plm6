<template>
  <common-table
    ...
    style="width: 100%"
  >
    <el-expand-table-column :data="form.steelCoilList" v-model:expand-row-keys="expandRowKeys" row-key="uid">
      <template #default="{ row }">
        <el-input v-model="row.remark" :rows="3" type="textarea" placeholder="备注" maxlength="1000" show-word-limit />
      </template>
    </el-expand-table-column>
    <el-table-column label="序号2" type="index" align="center" width="60" />
