...
import { inspectionDetailStatusEnum as inspectionEnum } from '@/utils/enum/modules/wms'
...
const inspectionAllV = inspectionEnum.UNREVIEWED.V | inspectionEnum.PASS.V | inspectionEnum.REFUSE.V
