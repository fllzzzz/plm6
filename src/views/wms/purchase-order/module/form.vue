        ...
        <el-form ref="formRef" :model="form" :rules="rules" size="small" label-position="top" inline label-width="200px">
          <div class="form-content">
            ...
            <el-form-item class="el-form-item-20" prop="areaIds">
              <area-table-tree
                v-if="baseMaterialTypeEnum.MANUFACTURED.V === form.purchaseType && isNotBlank(form.projectIds)"
...
useWatchFormValidate(formRef, form, [['areaIds', ['basicClass', 'strucAreaIds', 'enclAreaIds']]])
