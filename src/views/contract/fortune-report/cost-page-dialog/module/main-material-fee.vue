  ...
  <div class="app-container">
    <div class="head-container" style="display: flex; justify-content: space-between">
      <div style="width: 300px">
        <print-table api-key="mainMaterialList" :params="{ basicClassEnum: mainAuxiliaryTypeEnum.MAIN.V,projectId: props.costTypeData.projectId, }" size="mini" type="warning" class="filter-item" />
      </div>
