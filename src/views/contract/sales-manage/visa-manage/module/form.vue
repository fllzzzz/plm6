        ...
        <el-form v-loading="crud.editDetailLoading" :disabled="crud.status.cu === CRUD.STATUS.PROCESSING" ref="formRef" :model="form" :rules="rules" size="small" label-width="100px" class="demo-form">
          ...
          <div class="rule-row">
            <el-form-item label="监理单位" prop="supervisionUnit">
              <el-input v-model="form.supervisionUnit" placeholder="请输入监理单位" class="input-underline" maxlength="32" />
            </el-form-item>
            <el-form-item label="" />
          </div>
          <div class="rule-row">
            <el-form-item label="设计单位" prop="designUnit">
              <el-input v-model="form.designUnit" placeholder="请输入设计单位" class="input-underline" maxlength="32" />
            </el-form-item>
            <el-form-item label="" />
          </div>
          <div class="rule-row">
            <el-form-item label="政府监管" prop="governmentRegulation">
              <el-input v-model="form.governmentRegulation" placeholder="请输入政府监管" class="input-underline" maxlength="32" />
            </el-form-item>
            <el-form-item label="" />
          </div>
        </el-form>
