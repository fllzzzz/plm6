<template>
  <div class="modify-container">
    ...
    >
      ...
      <el-table-column v-if="columns.visible('enclosurePlan.name') && crud.query.type===contractSaleTypeEnum.ENCLOSURE.V" key="enclosurePlan.name" prop="enclosurePlan.name" label="计划" align="center" min-width="120" show-overflow-tooltip />
