<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column v-if="columns.visible('projectContentName')" key="projectContentName" prop="projectContentName" label="合同内容" min-width="150" show-overflow-tooltip />
      ...
      <el-table-column v-if="columns.visible('happenedRate')" key="happenedRate" prop="happenedRate" label="出库额比例" align="center" width="90">
        <template #default="{ row }">
