          ...
          <el-table-column key="collectionMode" prop="collectionMode" label="*收款方式" align="center" width="110">
            <template v-slot="scope">
              <common-select
                ...
                placeholder="收款方式"
                style="width:100%;"
                @change="collectionAmountChange(scope.row)"
              />
              <div v-else>{{ scope.row.collectionMode? paymentFineModeEnum.VL[scope.row.collectionMode]: '' }}</div>
            </template>
          </el-table-column>
          <el-table-column key="branchCompanyName" prop="branchCompanyName" label="*收款单位" align="center" min-width="120" :show-overflow-tooltip="true">
            <template v-slot="scope">
...
function addRow() {
  form.list.push({
    ...
    branchCompanyName: contractInfo.value.branchCompanyName || undefined,
    collectionUnitId: contractInfo.value.branchCompanyId || undefined,
    ...
    paymentUnit: contractInfo.value.purchaser || undefined,
...
function collectionAmountChange(row) {
