<template>
  ...
  >
    ...
    <template #titleRight>
      <div class="print-wrap">
        <print-table
          ...
          api-key="logisticsPaymentRecord"
          :params="{ ...params}"
          size="mini"
          type="warning"
        />
    ...
    <template #content>
      ...
      <el-table-column key="deductionAmount" prop="deductionAmount" label="让利金额" align="center" width="100px" />
...
<script setup>
import { paymentRecord } from '@/api/supply-chain/logistics-payment-manage/jd-logistics-record-ledger'
