...
import invoiceTypeSelect from '@comp-base/invoice-type-select-no-tax.vue'
...
const classification = supplierClassEnum.STEEL_PLATE.V | supplierClassEnum.SECTION_STEEL.V | supplierClassEnum.STEEL_COIL.V | supplierClassEnum.MATERIAL.V | supplierClassEnum.GAS.V | supplierClassEnum.STRUC_MANUFACTURED.V | supplierClassEnum.ENCL_MANUFACTURED.V
