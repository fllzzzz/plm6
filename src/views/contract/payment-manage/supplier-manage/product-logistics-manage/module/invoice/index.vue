<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="createInvoiceDate" label="开票日期" align="center" width="100" show-overflow-tooltip>
        <template v-slot="scope">
...
<script setup>
import crudApi from '@/api/contract/supplier-manage/jd-product-logistics-invoice'
...
import { contractSupplierProductLogisticsPM } from '@/page-permission/contract'
...
const permission = contractSupplierProductLogisticsPM.invoice
