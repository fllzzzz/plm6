<template>
  <div style="display: flex">
    ...
    >
      <template #auditBox>
        <el-badge v-permission="commonPermission.audit" :hidden="!auditNumberBadge" style="margin-right: 5px">
          <common-button size="mini" type="primary" :disabled="handleSelection.length === 0"  @click="auditVisible = true">批量调整工价</common-button>
        </el-badge>
      </template>
    </detail-list>
    <edit-drawer
