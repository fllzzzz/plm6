...
import crudApi from '@/api/mes/label-print/part'
...
import { partLabelPM as permission } from '@/page-permission/mes'
...
const productType = componentTypeEnum.MACHINE_PART.V | componentTypeEnum.ASSEMBLE.V
