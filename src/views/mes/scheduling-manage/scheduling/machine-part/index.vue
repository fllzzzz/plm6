  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column
        ...
        width="120px"
      />
      <productType-base-info-columns :productType="componentTypeEnum.MACHINE_PART.V" :columns="columns" :fixed="'left'" fixedWidth />
...
provide('productType', componentTypeEnum.MACHINE_PART.V)
