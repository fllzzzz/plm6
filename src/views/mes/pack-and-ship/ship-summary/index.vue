  ...
  <div class="app-container">
    ...
    <div style="display: flex">
      ...
      <div style="width: 59%; padding-left: 10px">
        <projectShipmentDetail :production-line-type-enum="crud.query.productionLineTypeEnum" :currentRow="currentRow" v-if="isNotBlank(currentRow)" :permission="permission"/>
