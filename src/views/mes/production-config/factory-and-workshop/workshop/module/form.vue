  ...
  >
    ...
    <el-form ref="formRef" :model="form" :rules="rules" size="small" label-width="90px">
      <el-form-item label="车间名称" prop="name">
        <el-input v-model.trim="form.name" type="text" placeholder="请填写名称" style="width: 270px" />
      </el-form-item>
...
const defaultForm = {
  id: undefined,
  factoryId: undefined,
  type: workshopTypeEnum.BUILDING.V,
  name: '',
  shortName: '',
  sort: 1,
  remark: ''
...
const rules = {
  ...
  shortName: [
    { required: false, message: '请填写车间简称', trigger: 'blur' },
    { min: 1, max: 32, message: '长度在 1 到 32 个字符', trigger: 'blur' }
  ],
