  ...
  <div class="app-container">
    <template v-if="pageShow">
      ...
      >
        ...
        >
          <template v-slot="scope">
            <el-input v-if="scope.row.isModify" v-model="scope.row.material" placeholder="材质" maxlength="10" style="width: 100%" />
            <div v-else>{{ scope.row.material ? scope.row.material : '-' }}</div>
          </template>
        </el-table-column>
        <el-table-column
