  ...
  children: [
    ...
    },
    {
      ...
      children: [
        ...
        // {
        //   name: 'PlanStructureList',
        //   path: 'mesStructureList',
        //   hidden: false,
        //   component: '',
        //   alwaysShow: false,
        //   redirect: '/plan/technical-manage/mesStructureList/artifact-tree',
        //   meta: { title: '构件工程', icon: 'project', noCache: true },
        //   children: [
        //     {
        //       name: 'PlanArtifactTreeList',
        //       path: 'artifact-tree',
        //       hidden: false,
        //       component: '/plan/technical-manage/artifact-tree/index',
        //       meta: { title: '构件零件清单', icon: 'project', noCache: true }
        //     },
        //     {
        //       name: 'PlanArtifactList',
        //       path: 'artifact',
        //       hidden: false,
        //       component: '/plan/technical-manage/artifact/index',
        //       meta: { title: '构件清单', icon: 'project', noCache: true }
        //     },
        //     {
        //       name: 'PlanMachinePartList',
        //       path: 'machine-part',
        //       hidden: false,
        //       component: '/plan/technical-manage/machine-part/index',
        //       meta: { title: '零件清单', icon: 'project', noCache: true }
        //     },
        //     {
        //       name: 'PlanAssemblyList',
        //       path: 'assembly',
        //       hidden: false,
        //       component: '/plan/technical-manage/assembly/index',
        //       meta: { title: '组立清单', icon: 'project', noCache: true }
        //     }
        //   ]
        // },
        // {
        //   name: 'PlanEnclosureList',
        //   path: 'planEnclosureList',
        //   hidden: false,
        //   component: '',
        //   alwaysShow: false,
        //   redirect: '/plan/technical-manage/planEnclosureList/trussSupport',
        //   meta: { title: '围护工程', icon: 'project', noCache: true },
        //   children: [
        //     {
        //       name: 'PlanTrussSupportList',
        //       path: 'trussSupport',
        //       hidden: false,
        //       component: '/plan/technical-manage/enclosure/trussSupport/index',
        //       meta: { title: '桁架楼层板清单', icon: 'project', noCache: true }
        //     },
        //     {
        //       name: 'PlanSandwichList',
        //       path: 'sandwich',
        //       hidden: false,
        //       component: '/plan/technical-manage/enclosure/sandwich/index',
        //       meta: { title: '夹芯板清单', icon: 'project', noCache: true }
        //     },
        //     {
        //       name: 'PlanPressedSupportList',
        //       path: 'pressedSupport',
        //       hidden: false,
        //       component: '/plan/technical-manage/enclosure/pressedSupport/index',
        //       meta: { title: '压型楼承板清单', icon: 'project', noCache: true }
        //     },
        //     {
        //       name: 'PlanPressedColorList',
        //       path: 'pressedColor',
        //       hidden: false,
        //       component: '/plan/technical-manage/enclosure/pressedColor/index',
        //       meta: { title: '压型板清单', icon: 'project', noCache: true }
        //     },
        //     {
        //       name: 'PlanBendingList',
        //       path: 'bending',
        //       hidden: false,
        //       component: '/plan/technical-manage/enclosure/bending/index',
        //       meta: { title: '折边件清单', icon: 'project', noCache: true }
        //     }
        //   ]
        // },
        // {
        ...
        // },
        // {
        //   path: '/plan/technical-data-manage',
        //   component: '',
        //   hidden: false,
        //   name: 'PlanTechnicalDataManage',
        //   alwaysShow: false,
        //   redirect: '/plan/technical-data-manage/deepen',
        //   meta: { title: '技术资料管理', icon: 'contract', noCache: true },
        //   children: [
        //     {
        //       name: 'PlanTechnicalDataManageDeepen',
        //       path: 'deepen',
        //       hidden: false,
        //       component: '/plan/technical-data-manage/deepen/index',
        //       meta: { title: '深化图纸', icon: 'project', noCache: true }
        //     },
        //     {
        //       name: 'PlanTechnicalDataManageBlueprint',
        //       path: 'blueprint',
        //       hidden: false,
        //       component: '/plan/technical-data-manage/blueprint/index',
        //       meta: { title: '蓝图', icon: 'project', noCache: true }
        //     },
        //     {
        //       name: 'PlanTechnicalDataManageChangeFile',
        //       path: 'change-file',
        ...
        //       hidden: false,
        //       component: '/plan/technical-data-manage/model/index',
        //       meta: { title: '模型', icon: 'project', noCache: true }
        //     },
        //     {
        //       name: 'PlanTechnicalDataManageOtherFile',
        //       path: 'other-file',
        //       hidden: false,
        //       component: '/plan/technical-data-manage/other-file/index',
        //       meta: { title: '其他文件', icon: 'project', noCache: true }
        //     }
        //   ]
        // }
        // {
        //   name: 'PlanSummaryList',
        //   path: 'summary-list',
        //   hidden: false,
        //   component: '/plan/technical-manage/summary-list/index',
        //   meta: { title: '合计清单', icon: 'project', noCache: true }
        // }
      ]
    }
  ]
