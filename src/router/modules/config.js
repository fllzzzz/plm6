  ...
  children: [
    {
      ...
      name: 'SubjectManage',
      alwaysShow: false,
      redirect: '/subject-manage/subject-config',
      ...
      children: [
        {
          ...
          path: 'subject-config',
          hidden: false,
          component: '/subject-manage/subject-config/index',
    ...
    //   name: 'WMSConfig',
    //   alwaysShow: false,
    //   redirect: '/wms-config/inventory-warning',
    ...
    //       path: 'base',
    //       hidden: false,
    //       component: '/wms-config/base/index',
