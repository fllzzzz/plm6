...
export default function useCrudAddFormLocalStorage(key, useDraftCallback) {
  ...
  // 在打开后开启缓存
  CRUD.HOOK.afterToAdd = () => openStore(ls, useDraftCallback)

  // 在退出后关闭缓存
  CRUD.HOOK.beforeAddCancel = () => closeStore(ls)
