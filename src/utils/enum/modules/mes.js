...
const wageQuotaTypeEnum = {
  WEIGHT: { L: '按重量计价', K: 'WEIGHT', V: 1 << 0, F: 'weightPrice', unit: '元/吨', meteUnit: '吨', C_UNIT: 't' },
  LENGTH: { L: '按长度计价', K: 'LENGTH', V: 1 << 1, F: 'lengthPrice', unit: '元/米', meteUnit: '米', C_UNIT: 'm' },
  AREA: { L: '按面积计价', K: 'AREA', V: 1 << 2, F: 'areaPice', unit: '元/平方米', meteUnit: '平方米', C_UNIT: '㎡' }
}
