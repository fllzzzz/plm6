...
if (needCLodop()) {
  ...
  var src1, src2
  if (protocol == 'https:') {
    src1 = 'https://localhost.lodop.net:8443/CLodopfuncs.js?priority=1'
    src2 = 'https://localhost.lodop.net:8444/CLodopfuncs.js?priority=0'
  } else {
...
export function getLodop(oOBJECT, oEMBED) {
  ...
  try {
    ...
    LODOP.SET_LICENSES('杭州初鸣建筑科技有限公司', 'BD6BDE9D8EE17DF1657250C8A683CA3B', '杭州初鳴建築科技有限公司', '7DD751D31FEE2807E53FB93B8756906F')
