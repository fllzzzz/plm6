...
// 计划制定
const BRIDGE_MES_AREA_PLAN = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'BRIDGE_MES_AREA_PLAN', // 表格类型 KEY
  name: '计划制定（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  ...
  header: {
    ...
    fields: [ // 字段内容
      ...
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'materialType', title: '类别：', width: 40, type: typeEnum.ENUM.K, format: { enum: 'brMaterialTypeEnum', key: 'L' }},
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'monomer', title: '单体：', width: 150, type: typeEnum.MONOMER_NAME.K },
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'type', title: '计划：', width: 40, type: typeEnum.ENUM.K, format: { enum: 'overallPlanTypeEnum', key: 'L' }},
  ...
  table: {
     ...
     */
    fields: [
      { show: true, key: 'name', title: '区域名称', source: dataSourceEnum.SYSTEM.V, align: alignEnum.LEFT.V, minWidth: 18, type: typeEnum.AREA_NAME.K },
      { show: true, key: 'divide', title: '区域划分', source: dataSourceEnum.SYSTEM.V, align: alignEnum.LEFT.V, minWidth: 18, type: typeEnum.AREA_DIVIDE.K },
