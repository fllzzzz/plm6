...
// 生产表(工厂)
const BRIDGE_MES_REPORT_FACTORY_PRODUCTION = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'BRIDGE_MES_REPORT_FACTORY_PRODUCTION', // 表格类型 KEY
  name: '生产表(工厂)（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  ...
  header: {
     ...
     */
    fields: [ // 字段内容
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'factory', title: '工厂：', width: 105, type: typeEnum.FACTORY_NAME.K },
...
export default {
  BRIDGE_MES_REPORT_FACTORY_PRODUCTION // 生产表(工厂)
}
