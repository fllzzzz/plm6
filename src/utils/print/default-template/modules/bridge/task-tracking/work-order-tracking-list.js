...
// 工单跟踪
const bridgeWorkOrderTrackingList = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'bridgeWorkOrderTrackingList', // 表格类型 KEY
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'completeQuantity', title: '完成', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.QUANTITY.K },
...
export default {
  bridgeWorkOrderTrackingList // 工单跟踪
}
