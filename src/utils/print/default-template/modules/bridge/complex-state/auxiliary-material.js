...
// 辅材汇总统计表
const BRIDGE_MES_COMPLEX_STATE_AUXILIARY_MATERIAL = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'BRIDGE_MES_COMPLEX_STATE_AUXILIARY_MATERIAL', // 表格类型 KEY
  name: '辅材出入库状态（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  paddingTB: 10, // 上下内边距
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'outboundQuantity', title: '出库数量', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.QUANTITY.K, format: { toThousandFilter: false, precision: 0 }},
      { show: true, key: 'receiptQuantity', title: '收货数量', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.QUANTITY.K, format: { toThousandFilter: false, precision: 0 }}
    ]
  }
}

export default {
  BRIDGE_MES_COMPLEX_STATE_AUXILIARY_MATERIAL //  辅材汇总统计表
}
