...
// 围护项目汇总
const bridgeEnclosureProjectSummary = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'bridgeEnclosureProjectSummary', // 表格类型 KEY
  name: '围护项目汇总（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  ...
  header: {
    ...
    fields: [ // 字段内容
      ...
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'date', title: '统计日期：', width: 70, type: typeEnum.OTHER.K },
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'monomer.name', title: '单体：', width: 100, type: typeEnum.MONOMER_NAME.K },
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'area.name', title: '区域：', width: 60, type: typeEnum.AREA_NAME.K },
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'category', title: '类型：', width: 30, type: typeEnum.OTHER.K },
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'material', title: '规格', source: dataSourceEnum.SYSTEM.V, align: alignEnum.LEFT.V, minWidth: 18, type: typeEnum.SPECIFICATION.K },
      { show: true, key: 'quantity', title: '数量(张)', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 14, type: typeEnum.QUANTITY.K, format: { toThousand: false, precision: 0 }},
      { show: true, key: 'mete', title: '单长(M)', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.LENGTH.K, format: { toThousand: false, precision: 3, unit: lengthUnitEnum.M.V }},
      { show: true, key: 'completeQuantity', title: '生产数(张)', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 14, type: typeEnum.QUANTITY.K, format: { toThousand: false, precision: 0 }},
      { show: true, key: 'completeMete', title: '生产量(M)', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 20, type: typeEnum.OTHER.K },
      { show: true, key: 'sendQuantity', title: '发运数(张)', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 14, type: typeEnum.QUANTITY.K, format: { toThousand: false, precision: 0 }},
      { show: true, key: 'shipMete', title: '发运量(M)', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 20, type: typeEnum.OTHER.K }
    ]
  }
}
