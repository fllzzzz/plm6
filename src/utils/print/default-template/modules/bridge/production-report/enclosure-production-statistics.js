...
// 围护在制品统计
const bridgeEnclosureProductionStatistics = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'bridgeEnclosureProductionStatistics', // 表格类型 KEY
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, title: '任务量（件/M）', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, children:
        [
          ...
          { show: true, key: 'taskLength', title: '长度', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.LENGTH.K, format: { toThousand: false, precision: 3, unit: lengthUnitEnum.M.V }, sum: true }
        ]
      },
      { show: true, title: '已完成（件/M）', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, children:
        [
          ...
          { show: true, key: 'completeLength', title: '长度', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.LENGTH.K, format: { toThousand: false, precision: 3, unit: lengthUnitEnum.M.V }, sum: true }
        ]
      },
      { show: true, title: '在制品（件/M）', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, children:
        [
          ...
          { show: true, key: 'inProductionLength', title: '长度', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.LENGTH.K, format: { toThousand: false, precision: 3, unit: lengthUnitEnum.M.V }, sum: true }
        ]
      },
      { show: true, title: '未生产（件/M）', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, children:
        [
          ...
          { show: true, key: 'unProducedMete', title: '长度', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.LENGTH.K, format: { toThousand: false, precision: 3, unit: lengthUnitEnum.M.V }, sum: true }
        ]
      }
    ]
  }
