...
// 生产线质检报表
const bridgeQHSEProductionLineReport = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'bridgeQHSEProductionLineReport', // 表格类型 KEY
  name: '生产线质检不合格报表（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  paddingTB: 10, // 上下内边距
  ...
  header: {
     ...
     */
    fields: [ // 字段内容
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'productionLineName', title: '生产线：', width: 130, type: typeEnum.PRODUCTION_LINE.K },
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'artifactSerialNumber', title: '编号', source: dataSourceEnum.SYSTEM.V, align: alignEnum.LEFT.V, minWidth: 18, type: typeEnum.SERIAL_NUMBER.K },
      { show: true, key: 'qualityType', title: '问题', source: dataSourceEnum.SYSTEM.V, align: alignEnum.LEFT.V, minWidth: 18, type: typeEnum.OTHER.K },
      { show: true, key: 'productUserName', title: '制造人', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.USER_NAME.K },
      { show: true, key: 'inspectionUserName', title: '检验人', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.USER_NAME.K },
