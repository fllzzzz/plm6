...
// 收货状态汇总表
const BRIDGE_MES_PACK_RECEIPT = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'BRIDGE_MES_PACK_RECEIPT', // 表格类型 KEY
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'materialType', title: '装载货物', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.ENUM.K, format: { enum: 'brPackTypeEnum', key: 'L' }},
...
export default {
  BRIDGE_MES_PACK_RECEIPT //  收货状态汇总表
}
