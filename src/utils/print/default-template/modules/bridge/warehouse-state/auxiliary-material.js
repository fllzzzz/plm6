...
const BRIDGE_MES_WAREHOUSE_STATE_AUXILIARY_MATERIAL = {
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'outboundQuantity', title: '出库数量', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.QUANTITY.K, format: { toThousand: false, precision: 0 }, sum: true }
    ]
  }
}
