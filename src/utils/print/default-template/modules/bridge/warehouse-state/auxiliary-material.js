...
// 辅材出入库统计表
const BRIDGE_MES_WAREHOUSE_STATE_AUXILIARY_MATERIAL = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'BRIDGE_MES_WAREHOUSE_STATE_AUXILIARY_MATERIAL', // 表格类型 KEY
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'outboundQuantity', title: '出库数量', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.QUANTITY.K, format: { toThousandFilter: false, precision: 0 }, sum: true }
    ]
  }
}

export default {
  BRIDGE_MES_WAREHOUSE_STATE_AUXILIARY_MATERIAL //  辅材出入库统计表
}
