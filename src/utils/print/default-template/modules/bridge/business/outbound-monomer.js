...
// 出库表(单体)
const BRIDGE_MES_BUSINESS_OUTBOUND_MONOMER = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'BRIDGE_MES_BUSINESS_OUTBOUND_MONOMER', // 表格类型 KEY
  name: '出库表(单体)（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  ...
  header: {
    ...
    fields: [ // 字段内容
      ...
      { show: false, source: dataSourceEnum.SYSTEM.V, key: 'settlementType', title: '结算方式：', width: 40, type: typeEnum.ENUM.K, format: { enum: 'engineerSettlementTypeEnum', key: 'SL' }},
...
export default {
  BRIDGE_MES_BUSINESS_OUTBOUND_MONOMER //  出库表(单体)
}
