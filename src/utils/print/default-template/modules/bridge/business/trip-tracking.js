...
// 单次发货统计表
const BRIDGE_MES_BUSINESS_TRIP_TRACKING = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'BRIDGE_MES_BUSINESS_TRIP_TRACKING', // 表格类型 KEY
  ...
  header: {
    ...
    fields: [ // 字段内容
      ...
      { false: true, source: dataSourceEnum.SYSTEM.V, key: 'printDate', title: '打印日期：', width: 120, type: typeEnum.DATE.K, format: 'YY/MM/DD' },
      { false: true, source: dataSourceEnum.SYSTEM.V, key: 'printer', title: '打印人：', width: 60, type: typeEnum.USER_NAME.K }
    ]
  },
  /**
    * 表尾
...
export default {
  BRIDGE_MES_BUSINESS_TRIP_TRACKING // 单次发货统计表
}
