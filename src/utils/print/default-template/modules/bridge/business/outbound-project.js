...
// 出库表(汇总)
const BRIDGE_MES_BUSINESS_OUTBOUND_PROJECT = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'BRIDGE_MES_BUSINESS_OUTBOUND_PROJECT', // 表格类型 KEY
  name: '出库表(汇总)（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'material', title: '规格', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.MATERIAL.K },
...
export default {
  BRIDGE_MES_BUSINESS_OUTBOUND_PROJECT //  出库表(汇总)
}
