...
// 辅材计价表
const BRIDGE_MES_BUSINESS_ENTRY_AUXILIARY_MATERIAL = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'BRIDGE_MES_BUSINESS_ENTRY_AUXILIARY_MATERIAL', // 表格类型 KEY
  name: '辅材计价表（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'processingPrice', title: '材料单价', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.AMOUNT.K, format: { toThousand: true, precision: 2, unit: amountUnitEnum.YUAN.V }},
...
export default {
  BRIDGE_MES_BUSINESS_ENTRY_AUXILIARY_MATERIAL //  辅材计价表
}
