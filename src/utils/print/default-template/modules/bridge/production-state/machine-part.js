...
// 零件工序任务表
const BRIDGE_MES_PRODUCTION_STATE_MACHINE_PART = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'BRIDGE_MES_PRODUCTION_STATE_MACHINE_PART', // 表格类型 KEY
  name: '零件工序任务表（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  paddingTB: 10, // 上下内边距
  ...
  table: {
     ...
     */
    fields: [
      { show: true, key: 'serialNumber', title: '零件编号', source: dataSourceEnum.SYSTEM.V, align: alignEnum.LEFT.V, minWidth: 18, type: typeEnum.SERIAL_NUMBER.K },
...
export default {
  BRIDGE_MES_PRODUCTION_STATE_MACHINE_PART // 零件工序任务表
}
