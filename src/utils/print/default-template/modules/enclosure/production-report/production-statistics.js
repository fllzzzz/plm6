...
const enclosureProductionStatistics = {
  ...
  type: 'enclosureProductionStatistics', // 表格类型 KEY
  name: '围护生产统计（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  ...
  header: {
     ...
     */
    fields: [ // 字段内容
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'category', title: '围护类型：', width: 90, type: typeEnum.OTHER.K },
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'time', title: '统计日期：', width: 100, type: typeEnum.OTHER.K },
      { show: false, source: dataSourceEnum.SYSTEM.V, key: 'printDate', title: '打印时间：', width: 90, type: typeEnum.DATE.K, format: 'YY/MM/DD kk:mm:ss' },
      { show: false, source: dataSourceEnum.SYSTEM.V, key: 'printer', title: '打印人：', width: 100, type: typeEnum.USER_NAME.K }
    ]
  },
  /**
    * 表尾
