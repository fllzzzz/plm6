...
// 项目收款开票汇总表
const PROJECT_COLLECTION_SUMMARY = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'PROJECT_COLLECTION_SUMMARY', // 表格类型 KEY
  name: '项目收款开票汇总表（平台）', // 表格名称
  width: 297, // 打印纸的宽度
  height: 210, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  paddingTB: 10, // 上下内边距
  ...
  header: {
     ...
     */
    fields: [ // 字段内容
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'statisticsDate', title: '统计日期：', width: 150, type: typeEnum.DATE.K, format: 'YY/MM/DD' },
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'businessLeaderName', title: '业务负责人', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 20, type: typeEnum.USER_NAME.K },
      ...
      { show: false, key: 'collectionRate', title: '收款率', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 16, type: typeEnum.RATE.K, format: { precision: 2 }},
      ...
      { show: false, key: 'invoiceRate', title: '开票率', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 16, type: typeEnum.RATE.K, format: { precision: 2 }}
    ]
  }
}

export default {
  PROJECT_COLLECTION_SUMMARY // 项目收款开票汇总表
}
