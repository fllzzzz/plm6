...
const projectList = {
  ...
  table: {
    ...
    fields: [
      ...
      { show: false, key: 'signerName', title: '签约人', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.USER_NAME.K },
      ...
      { show: false, key: 'createTime', title: '立项日期', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.DATE.K, format: 'YY/MM/DD' },
