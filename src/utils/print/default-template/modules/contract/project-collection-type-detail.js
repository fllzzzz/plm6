...
// 项目收款分类明细表
const PROJECT_COLLECTION_TYPE_DETAIL = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'PROJECT_COLLECTION_TYPE_DETAIL', // 表格类型 KEY
  name: '项目收款分类明细表（平台）', // 表格名称
  width: 297, // 打印纸的宽度
  height: 210, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  paddingTB: 10, // 上下内边距
  ...
  header: {
    ...
    fields: [ // 字段内容
      ...
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'project', title: '项目：', width: 187, type: typeEnum.PROJECT.K, format: { showProjectFullName: false, showSerialNumber: true, projectNameShowConfig: projectNameArrangementModeEnum.SERIAL_NUMBER_START.V }},
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'applicantName', title: '填报人', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 14, type: typeEnum.USER_NAME.K },
      { show: true, key: 'paymentBank', title: '付款开户行', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 22, type: typeEnum.BANK.K },
...
export default {
  PROJECT_COLLECTION_TYPE_DETAIL // 项目收款分类明细表
}
