...
// 项目报销记录
const PROJECT_REIMBURSEMENT = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'PROJECT_REIMBURSEMENT', // 表格类型 KEY
  name: '项目报销记录表（平台）', // 表格名称
  width: 450, // 打印纸的宽度
  height: 210, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  paddingTB: 10, // 上下内边距
  ...
  header: {
    ...
    fields: [ // 字段内容
      ...
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'project', title: '项目：', width: 390, type: typeEnum.PROJECT.K, format: { showProjectFullName: false, showSerialNumber: true, projectNameShowConfig: projectNameArrangementModeEnum.SERIAL_NUMBER_START.V }},
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'project', title: '项目名称', source: dataSourceEnum.SYSTEM.V, align: alignEnum.LEFT.V, width: 29, minWidth: 29, type: typeEnum.PROJECT.K, format: { showProjectFullName: false, showSerialNumber: false, projectNameShowConfig: projectNameArrangementModeEnum.SERIAL_NUMBER_START.V }},
      ...
      { show: true, key: 'reimbursementType', title: '报销类型', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, width: 29, minWidth: 29, type: typeEnum.REIMBURSEMENT_TYPE.K },
      { show: true, key: 'applicationAmount', title: '报销金额', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, width: 29, minWidth: 29, type: typeEnum.AMOUNT.K, format: { toThousand: true, precision: 2, unit: amountUnitEnum.YUAN.V }, sum: true },
      { show: true, key: 'paymentAmount', title: '实付金额', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, width: 29, minWidth: 29, type: typeEnum.AMOUNT.K, format: { toThousand: true, precision: 2, unit: amountUnitEnum.YUAN.V }, sum: true },
      { show: true, key: 'payer', title: '付款方', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, width: 29, minWidth: 29, type: typeEnum.COMPANY_NAME.K },
      ...
      { show: true, key: 'payee', title: '收款方', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, width: 29, minWidth: 29, type: typeEnum.COMPANY_NAME.K },
      ...
      { show: true, key: 'handlerName', title: '办理人', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 17, type: typeEnum.USER_NAME.K },
      { show: false, key: 'remark', title: '备注', source: dataSourceEnum.SYSTEM.V, align: alignEnum.LEFT.V, minWidth: 18, type: typeEnum.OTHER.K }
    ]
  }
}
