...
const testingFee = {
  ...
  table: {
     ...
     */
    fields: [
      { show: true, key: 'testingFeeTypeName', title: '科目', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 22, type: typeEnum.GUID.K },
