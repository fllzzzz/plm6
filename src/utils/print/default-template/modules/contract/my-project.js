...
const myProject = {
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'status', title: '状态', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.ENUM.K, format: { enum: 'projectStatusEnum', key: 'L' }},
      ...
      { show: true, key: 'startDate', title: '计划开工', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.DATE.K, format: 'YY/MM/DD' },
      { show: true, key: 'endDate', title: '计划完工', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.DATE.K, format: 'YY/MM/DD' },
      { show: true, key: 'completeDate', title: '完工日期', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.DATE.K, format: 'YY/MM/DD' },
      ...
      { show: true, key: 'alreadyDays', title: '已用时', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, width: 14, type: typeEnum.QUANTITY.K, format: { toThousand: false, precision: 0 }}
    ]
  }
}
