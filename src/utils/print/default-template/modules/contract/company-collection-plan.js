...
const COMPANY_COLLECTION_PLAN = {
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'amount', title: '计划收款', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.AMOUNT.K, format: { toThousandFilter: true, precision: 2, unit: amountUnitEnum.YUAN.V }, sum: true },
