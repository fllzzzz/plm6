...
const contractDeviceDepreciationRecord = {
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'totalDepreciationAmount', title: '累计折旧额', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.AMOUNT.K, format: { toThousand: true, precision: DP.YUAN, unit: amountUnitEnum.YUAN.V }, sum: true },
      ...
      { show: true, key: 'boolStatus', title: '状态', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, width: 12, type: typeEnum.ENUM.K, format: { enum: 'enabledEnum', key: 'L' }}
    ]
  }
}
