...
const gasRecord = {
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'totalAmount', title: '总额', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.AMOUNT.K, format: { toThousand: true, precision: DP.YUAN, UNIT: typeEnum.AMOUNT.K }, sum: true },
      { show: true, key: 'avgUnitPrice', title: '平均单价', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.AMOUNT.K, format: { toThousand: true, precision: DP.YUAN, UNIT: typeEnum.AMOUNT.K }},
