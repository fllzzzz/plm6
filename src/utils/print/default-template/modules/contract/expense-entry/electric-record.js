...
const electricRecord = {
  ...
  header: {
     ...
     */
    fields: [ // 字段内容
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'year', title: '统计日期：', width: 150, type: typeEnum.OTHER.K },
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'type', title: '类型：', width: 40, type: typeEnum.OTHER.K },
  ...
  table: {
     ...
     */
    fields: [
      { show: true, key: 'date', title: '时间', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.OTHER.K },
      ...
      { show: true, key: 'totalAmount', title: '电费（元）', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.AMOUNT.K, format: { toThousand: true, precision: DP.YUAN, UNIT: typeEnum.AMOUNT.K }, sum: true },
      { show: true, key: 'unitAmount', title: '平均电费（元/kw·h）', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.AMOUNT.K, format: { toThousand: true, precision: DP.YUAN, UNIT: typeEnum.AMOUNT.K }},
      { show: true, key: 'isAmortization', title: '是否摊销', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.ENUM.K, format: { enum: 'whetherEnum', key: 'L' }}
    ]
  }
}
