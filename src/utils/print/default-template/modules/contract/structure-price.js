...
const contractStructurePrice = {
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'totalWeight', title: '总量', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.METE.K, format: { toThousand: false, precision: 3 }, sum: true },
