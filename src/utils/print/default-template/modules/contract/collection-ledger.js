...
const collectionLedger = {
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'collectionUnit', title: '签约主体', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 22, type: typeEnum.COMPANY_NAME.K },
      ...
      { show: true, key: 'collectionReason', title: '收款事由', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.PAYMENT_REASON.K }
    ]
  }
}
