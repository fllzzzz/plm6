...
// 围护制品
const contractEnclosureProduct = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'contractEnclosureProduct', // 表格类型 KEY
  name: '围护制品（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  ...
  header: {
    ...
    fields: [ // 字段内容
      ...
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'statisticalDate', title: '统计日期：', width: 110, type: typeEnum.OTHER.K },
  ...
  table: {
     ...
     */
    fields: [
      { show: true, key: 'name', title: '批次', source: dataSourceEnum.SYSTEM.V, align: alignEnum.LEFT.V, minWidth: 18, type: typeEnum.OTHER.K },
      ...
      { show: true, key: 'length', title: '单长', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.LENGTH.K, format: { toThousand: false, precision: 3, unit: lengthUnitEnum.M.V }},
      ...
      { show: true, key: 'totalLength', title: '总长', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.LENGTH.K, format: { toThousand: false, precision: 3, unit: lengthUnitEnum.M.V }},
      ...
      { show: true, key: 'shipmentTime', title: '发运日期', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 20 }
    ]
  }
}
