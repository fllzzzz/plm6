...
const SHIP_INFO = {
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'mete', title: '单量', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 14, type: typeEnum.METE.K, format: { toThousandFilter: true, precision: 3 }, sum: false },
      { show: true, key: 'totalMete', title: '总量', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.METE.K, format: { toThousandFilter: false, precision: 3 }, sum: true },
