...
const auxiliaryMaterialList = {
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'classifyName', title: '物料种类', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.OTHER.K },
      ...
      { show: true, key: 'outboundTime', title: '出库日期', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.DATE.K, format: 'YY/MM/DD kk:mm:ss' }
    ]
  }
}
