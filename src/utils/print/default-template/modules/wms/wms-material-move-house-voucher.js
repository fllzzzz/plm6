...
// 物料调拨单
const WMS_MATERIAL_MOVE_HOUSE_VOUCHER = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'WMS_MATERIAL_MOVE_HOUSE_VOUCHER', // 表格类型 KEY
  name: '物料调拨单（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  ...
  header: {
     ...
     */
    fields: [ // 字段内容
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'originPlace', title: '原属库：', width: 135, type: typeEnum.PROJECT.K, format: { showProjectFullName: false, showContractNo: true, projectNameShowConfig: projectNameArrangementModeEnum.CONTRACT_NO_START.V }},
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'originType', title: '原物料类型：', width: 55, type: typeEnum.ENUM.K, format: { enum: 'materialUseTypeEnum', key: 'L' }},
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'targetProject', title: '调拨至：', width: 135, type: typeEnum.PROJECT.K, format: { showProjectFullName: false, showContractNo: true, projectNameShowConfig: projectNameArrangementModeEnum.CONTRACT_NO_START.V }},
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'createTime', title: '调拨时间：', width: 55, type: typeEnum.DATE.K, format: 'YY/MM/DD kk:mm:ss' },
  ...
  footer: {
     ...
     */
    fields: [
      { show: true, source: dataSourceEnum.CUSTOMIZE.V, key: 'createUserName', title: '制表：', width: 85 },
  ...
  table: {
    ...
    fields: [
      ...
      { show: false, key: 'number', title: '调拨数', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.QUANTITY.K, format: { toThousandFilter: false, precision: 0 }, sum: true },
      ...
      { show: true, key: 'value', title: '调拨量', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.METE.K, format: { toThousandFilter: false, precision: 3 }, sum: true },
      { show: true, key: 'unitPrice', title: '单价', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.AMOUNT.K, format: { toThousandFilter: true, precision: 2, unit: amountUnitEnum.YUAN.V }, sum: false },
      { show: true, key: 'totalAmount', title: '金额', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.AMOUNT.K, format: { toThousandFilter: true, precision: 2, unit: amountUnitEnum.YUAN.V }, sum: true }
    ]
  }
}

export default {
  WMS_MATERIAL_MOVE_HOUSE_VOUCHER // 物料调拨单
}
