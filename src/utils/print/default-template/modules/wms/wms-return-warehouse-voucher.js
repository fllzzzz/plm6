...
const WMS_RETURN_WAREHOUSE_VOUCHER = {
  ...
  header: {
    ...
    fields: [ // 字段内容
      ...
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'originProject', title: '原属地：', width: 135, type: typeEnum.PROJECT.K, format: { showProjectFullName: false, showContractNo: true, projectNameShowConfig: projectNameArrangementModeEnum.CONTRACT_NO_START.V }},
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'createUserName', title: '办理人：', width: 55, type: typeEnum.USER_NAME.K },
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'targetProject', title: '还库至：', width: 135, type: typeEnum.PROJECT.K, format: { showProjectFullName: false, showContractNo: true, projectNameShowConfig: projectNameArrangementModeEnum.CONTRACT_NO_START.V }},
  ...
  footer: {
     ...
     */
    fields: [
      { show: true, source: dataSourceEnum.CUSTOMIZE.V, key: 'createUserName', title: '操作：', width: 85 },
  ...
  table: {
     ...
     */
    fields: [
      { show: false, key: 'serialNumber', title: '编号', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.SERIAL_NUMBER.K },
      ...
      { show: false, key: 'number', title: '还库数', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.QUANTITY.K, format: { toThousandFilter: false, precision: 0 }},
      ...
      { show: true, key: 'value', title: '还库量', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 20, type: typeEnum.METE.K, format: { toThousandFilter: false, precision: 3 }, sum: false },
      { show: false, key: 'unitPrice', title: '单价', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 20, type: typeEnum.AMOUNT.K, format: { toThousandFilter: true, precision: 2, unit: amountUnitEnum.YUAN.V }, sum: false },
