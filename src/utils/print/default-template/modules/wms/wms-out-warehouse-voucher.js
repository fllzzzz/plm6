import { orientEnum, dataSourceEnum, alignEnum, verticleAlignEnum, fieldTypeEnum as typeEnum, cssUnitEnum, cssUnitPrecisionEnum, pageFormatEnum } from '@/utils/print/enum'
import { projectNameArrangementModeEnum } from '@/utils/enum/modules/contract'

// 出库（领料）单
const WMS_OUT_WAREHOUSE_VOUCHER = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'WMS_OUT_WAREHOUSE_VOUCHER', // 表格类型 KEY
  ...
  header: {
     ...
     */
    fields: [ // 字段内容
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'outboundTime', title: '出库日期：', width: 55, type: typeEnum.DATE.K, format: 'YYYY年MM月DD日' },
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'createUserName', title: '出库办理人：', width: 55, type: typeEnum.USER_NAME.K },
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'outboundNo', title: 'NO：', width: 55, type: typeEnum.GUID.K },
  ...
  footer: {
     ...
     */
    fields: [
      { show: true, source: dataSourceEnum.CUSTOMIZE.V, key: 'createUserName', title: '领料人（签字）：', width: 85 },
      { show: true, source: dataSourceEnum.CUSTOMIZE.V, key: 'checkUserName', title: ' 审核人（签字）：', width: 85 }
    ]
  },
  table: {
    /**
    ...
    fields: [
      ...
      { show: true, key: 'value', title: '出库量', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.METE.K, format: { toThousand: false, precision: 3 }, sum: true },
      ...
      { show: true, key: 'receiverUserName', title: '领用人', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.USER_NAME.K }
    ]
  }
}

export default {
  WMS_OUT_WAREHOUSE_VOUCHER // 出库（领料）单
}
