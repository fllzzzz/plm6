...
// 入库记录汇总详情
const WMS_IN_RECORD_SUMMARY_DETAIL = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'WMS_IN_RECORD_SUMMARY_DETAIL', // 表格类型 KEY
  name: '入库汇总明细表（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  paddingTB: 10, // 上下内边距
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'unit', title: '计量单位', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, width: 10, type: typeEnum.ACCOUNTING_UNIT.K },
      { show: true, key: 'quantity', title: '数量', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, width: 10, type: typeEnum.QUANTITY.K, format: { toThousand: false, precision: 0 }, sum: false },
      ...
      { show: true, key: 'supplierName', title: '供应商名称', source: dataSourceEnum.SYSTEM.V, align: alignEnum.LEFT.V, minWidth: 30, type: typeEnum.COMPANY_NAME.K },
      { show: true, key: 'project', title: '所属项目', source: dataSourceEnum.SYSTEM.V, align: alignEnum.LEFT.V, minWidth: 25, type: typeEnum.PROJECT.K, format: { showProjectFullName: false, showSerialNumber: true, projectNameShowConfig: projectNameArrangementModeEnum.SERIAL_NUMBER_START.V }},
      ...
      { show: false, key: 'warehouse', title: '仓库位置', source: dataSourceEnum.SYSTEM.V, align: alignEnum.LEFT.V, minWidth: 18, type: typeEnum.WAREHOUSE_NAME.K },
      { show: true, key: 'storageTime', title: '入库日期', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.DATE.K, format: 'YY/MM/DD' },
      { show: true, key: 'transportType', title: '提货方式', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.ENUM.K, format: { enum: 'pickUpModeEnum', key: 'L' }}
    ]
  }
}

export default {
  WMS_IN_RECORD_SUMMARY_DETAIL // 入库记录汇总详情
}
