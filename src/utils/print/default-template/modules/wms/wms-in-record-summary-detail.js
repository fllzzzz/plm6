...
const WMS_IN_RECORD_SUMMARY_DETAIL = {
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'quantity', title: '数量', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, width: 10, type: typeEnum.QUANTITY.K, format: { toThousandFilter: false, precision: 0 }, sum: false },
