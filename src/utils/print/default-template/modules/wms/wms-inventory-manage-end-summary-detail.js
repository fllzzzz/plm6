...
// 物料盘存-当前库存汇总明细表
const WMS_INVENTORY_MANAGE_END_SUMMARY_DETAIL = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'WMS_INVENTORY_MANAGE_END_SUMMARY_DETAIL', // 表格类型 KEY
  name: '物料盘存期末汇总明细表（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  paddingTB: 10, // 上下内边距
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'mete', title: '库存量', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.METE.K, format: { toThousand: false, precision: 3 }, sum: true },
