...
// 出库记录汇总详情
const WMS_OUT_RECORD_SUMMARY_DETAIL = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'WMS_OUT_RECORD_SUMMARY_DETAIL', // 表格类型 KEY
  name: '出库汇总明细表（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  paddingTB: 10, // 上下内边距
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'factoryName', title: '使用工厂', source: dataSourceEnum.SYSTEM.V, align: alignEnum.LEFT.V, minWidth: 18, type: typeEnum.FACTORY_NAME.K },
...
export default {
  WMS_OUT_RECORD_SUMMARY_DETAIL // 出库记录汇总详情
}
