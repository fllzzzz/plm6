...
import { lengthUnitEnum, weightUnitEnum } from '../../../../enum'

// 型材采购清单
const WMS_PREPARES_CUSTOM_SECTION_STEEL = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'WMS_PREPARES_CUSTOM_SECTION_STEEL', // 表格类型 KEY
  name: '型材采购清单（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
...
export default {
  WMS_PREPARES_CUSTOM_SECTION_STEEL // 型材采购清单
}
