...
const WMS_PREPARES_CUSTOM_SUMMARY = {
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'value', title: '采购量', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.METE.K, format: { toThousand: false, precision: 3 }, sum: true },
