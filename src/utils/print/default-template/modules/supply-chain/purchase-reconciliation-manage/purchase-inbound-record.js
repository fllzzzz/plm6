...
const purchaseInboundRecord = {
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'quantity', title: '入库数', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, type: typeEnum.QUANTITY.K, format: { toThousand: false, precision: 0 }, sum: true },
