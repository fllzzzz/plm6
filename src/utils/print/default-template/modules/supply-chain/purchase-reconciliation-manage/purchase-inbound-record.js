...
const purchaseInboundRecord = {
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'materialSn', title: '物料编号', source: dataSourceEnum.SYSTEM.V, align: alignEnum.LEFT.V, minWidth: 12, type: typeEnum.SERIAL_NUMBER.K },
      ...
      { show: true, key: 'mete', title: '入库量', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 16, type: typeEnum.METE.K, format: { toThousand: false, rowUnit: 'accountingUnit' }, sum: true },
      ...
      { show: true, key: 'inputVat', title: '进项税', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 14, type: typeEnum.AMOUNT.K, format: { toThousand: true, precision: 2, unit: amountUnitEnum.YUAN.V }, sum: true },
