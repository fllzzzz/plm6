...
const PROJECT_MATERIAL_RETURN_CONT = {
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'number', title: '还库数', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.QUANTITY.K, format: { toThousand: false, precision: 0 }, sum: true },
      ...
      { show: true, key: 'value', title: '还库量', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.METE.K, format: { toThousand: false, precision: 3 }, sum: true },
      ...
      { show: true, key: 'totalAmount', title: '还库总额', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.AMOUNT.K, format: { toThousand: true, precision: 2, unit: amountUnitEnum.YUAN.V }, sum: true }
    ]
  }
}
