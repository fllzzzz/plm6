...
const PROJECT_MATERIAL_RETURN_CONT = {
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'number', title: '退库数', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.QUANTITY.K, format: { toThousand: false, precision: 0 }, sum: true },
      ...
      { show: true, key: 'totalAmount', title: '退库总额', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.AMOUNT.K, format: { toThousand: true, precision: 2, unit: amountUnitEnum.YUAN.V }, sum: true }
    ]
  }
}
