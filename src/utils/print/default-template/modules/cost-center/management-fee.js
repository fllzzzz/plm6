...
// 项目管理费
const PROJECT_MANAGEMENT_FEE = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'PROJECT_MANAGEMENT_FEE', // 表格类型 KEY
  name: '项目管理费（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  ...
  header: {
    ...
    fields: [ // 字段内容
      ...
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'expenseType', title: '费用分类：', width: 150, type: typeEnum.REIMBURSEMENT_TYPE.K },
