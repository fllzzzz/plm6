...
// 安装表(单体)
const STEEL_MES_BUSINESS_INSTALLATION_MONOMER = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'STEEL_MES_BUSINESS_INSTALLATION_MONOMER', // 表格类型 KEY
  name: '安装表(单体)（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'price', title: '综合单价', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.AMOUNT.K, format: { toThousandFilter: true, precision: 2, unit: amountUnitEnum.YUAN.V }},
...
export default {
  STEEL_MES_BUSINESS_INSTALLATION_MONOMER //  安装表(单体)
}
