...
// 单次发货统计表
const STEEL_MES_BUSINESS_TRIP_TRACKING = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'STEEL_MES_BUSINESS_TRIP_TRACKING', // 表格类型 KEY
  name: '单次发货统计表（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  paddingTB: 10, // 上下内边距
  ...
  header: {
    ...
    fields: [ // 字段内容
      ...
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'licensePlate', title: '车牌号：', width: 150, type: typeEnum.LICENSE_PLATE.K },
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'deliveryTime', title: '发货日期：', width: 40, type: typeEnum.DATE.K, format: 'YY/MM/DD' },
      { show: false, source: dataSourceEnum.SYSTEM.V, key: 'manufactureType', title: '类型：', width: 50, type: typeEnum.ENUM.K, format: { enum: 'manufactureTypeEnum', key: 'L' }},
      { show: false, source: dataSourceEnum.SYSTEM.V, key: 'enclosurePriceType', title: '围护结算方式：', width: 50, type: typeEnum.ENUM.K, format: { enum: 'enclosureSettlementTypeEnum', key: 'SL' }},
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'measurementUnit', title: '计量单位', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, width: 12, type: typeEnum.MEASUREMENT_UNIT.K },
      ...
      { show: true, key: 'totalMete', title: '总量', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.METE.K, format: { toThousandFilter: false, precision: 3 }, sum: false },
      { show: true, key: 'price', title: '单价', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.AMOUNT.K, format: { toThousandFilter: true, precision: 2, unit: amountUnitEnum.YUAN.V }},
...
export default {
  STEEL_MES_BUSINESS_TRIP_TRACKING // 单次发货统计表
}
