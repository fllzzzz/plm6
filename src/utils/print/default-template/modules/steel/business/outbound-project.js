...
// 出库表(汇总)
const STEEL_MES_BUSINESS_OUTBOUND_PROJECT = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'STEEL_MES_BUSINESS_OUTBOUND_PROJECT', // 表格类型 KEY
  name: '出库表(汇总)（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  ...
  header: {
    ...
    fields: [ // 字段内容
      ...
      { show: false, source: dataSourceEnum.SYSTEM.V, key: 'settlementType', title: '结构结算方式：', width: 40, type: typeEnum.ENUM.K, format: { enum: 'engineerSettlementTypeEnum', key: 'SL' }},
      { show: false, source: dataSourceEnum.SYSTEM.V, key: 'enclosurePriceType', title: '围护结算方式：', width: 40, type: typeEnum.ENUM.K, format: { enum: 'enclosureSettlementTypeEnum', key: 'SL' }},
      { show: false, source: dataSourceEnum.SYSTEM.V, key: 'weightType', title: '重量类型：', width: 40, type: typeEnum.ENUM.K, format: { enum: 'weightTypeEnum', key: 'L' }},
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'projectMaterial', title: '材质/规格', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.MATERIAL.K },
      ...
      { show: true, key: 'totalMete', title: '总量', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.METE.K, format: { toThousandFilter: false, precision: 3 }},
...
export default {
  STEEL_MES_BUSINESS_OUTBOUND_PROJECT //  出库表(汇总)
}
