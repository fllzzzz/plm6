...
// 产量工资表
const STEEL_MES_REPORT_OUTPUT_WAGE = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'STEEL_MES_REPORT_OUTPUT_WAGE', // 表格类型 KEY
  name: '产量工资表（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  ...
  header: {
     ...
     */
    fields: [ // 字段内容
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'factory', title: '工厂/生产线：', width: 130, type: typeEnum.PRODUCTION_LINE.K },
...
export default {
  STEEL_MES_REPORT_OUTPUT_WAGE // 产量工资表
}
