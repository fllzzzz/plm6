...
// 围护生产表(工厂)
const STEEL_MES_REPORT_FACTORY_PRODUCTION_ENCLOSURE = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'STEEL_MES_REPORT_FACTORY_PRODUCTION_ENCLOSURE', // 表格类型 KEY
  name: '围护生产表(工厂)（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  paddingTB: 10, // 上下内边距
  ...
  header: {
     ...
     */
    fields: [ // 字段内容
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'factory', title: '工厂：', width: 130, type: typeEnum.FACTORY_NAME.K },
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'statisticsDate', title: '统计日期：', width: 60, type: typeEnum.DATE.K, format: 'YY/MM/DD' },
  ...
  table: {
    ...
    fields: [
      ...
      { show: false, key: 'factory', title: '工厂', source: dataSourceEnum.SYSTEM.V, align: alignEnum.LEFT.V, minWidth: 18, type: typeEnum.FACTORY_NAME.K },
...
export default {
  STEEL_MES_REPORT_FACTORY_PRODUCTION_ENCLOSURE // 围护生产表(工厂)
}
