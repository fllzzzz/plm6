...
// 辅材出库表(项目)
const STEEL_MES_REPORT_OUTBOUND_PROJECT_AUXILIARY_MATERIAL = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'STEEL_MES_REPORT_OUTBOUND_PROJECT_AUXILIARY_MATERIAL', // 表格类型 KEY
...
export default {
  STEEL_MES_REPORT_OUTBOUND_PROJECT_AUXILIARY_MATERIAL // 辅材出库表(项目)
}
