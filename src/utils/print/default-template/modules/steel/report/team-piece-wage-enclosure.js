...
// 围护班组计件工资表
const STEEL_MES_REPORT_TEAM_PIECE_WAGE_ENCLOSURE = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'STEEL_MES_REPORT_TEAM_PIECE_WAGE_ENCLOSURE', // 表格类型 KEY
  name: '围护班组计件工资表（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  paddingTB: 10, // 上下内边距
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'productionLength', title: '生产长度', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.LENGTH.K, format: { toThousandFilter: false, precision: 3, unit: lengthUnitEnum.M.V }, sum: true },
...
export default {
  STEEL_MES_REPORT_TEAM_PIECE_WAGE_ENCLOSURE // 围护班组计件工资表
}
