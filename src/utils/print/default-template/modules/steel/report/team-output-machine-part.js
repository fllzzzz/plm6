...
// 零件产量表(班组)
const STEEL_MES_REPORT_TEAM_OUTPUT_MACHINE_PART = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'STEEL_MES_REPORT_TEAM_OUTPUT_MACHINE_PART', // 表格类型 KEY
...
export default {
  STEEL_MES_REPORT_TEAM_OUTPUT_MACHINE_PART // 零件产量表(班组)
}
