...
// 围护安装表(项目)
const STEEL_MES_REPORT_INSTALLATION_ENCLOSURE = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'STEEL_MES_REPORT_INSTALLATION_ENCLOSURE', // 表格类型 KEY
  name: '围护安装表(项目)（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  paddingTB: 10, // 上下内边距
...
export default {
  STEEL_MES_REPORT_INSTALLATION_ENCLOSURE // 围护安装表(项目)
}
