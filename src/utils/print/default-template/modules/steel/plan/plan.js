...
// 计划制定
const STEEL_MES_AREA_PLAN = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'STEEL_MES_AREA_PLAN', // 表格类型 KEY
  name: '计划制定（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  ...
  header: {
    ...
    fields: [ // 字段内容
      ...
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'materialType', title: '类别：', width: 40, type: typeEnum.ENUM.K, format: { enum: 'componentTypeEnum', key: 'L' }},
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'axis', title: '轴线/标高', source: dataSourceEnum.SYSTEM.V, align: alignEnum.LEFT.V, minWidth: 18, type: typeEnum.AREA_AXIS.K },
