...
// 区域制定
const STEEL_MES_AREA = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'STEEL_MES_AREA', // 表格类型 KEY
  name: '区域制定（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  ...
  header: {
    ...
    fields: [ // 字段内容
      ...
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'project', title: '项目：', width: 190, type: typeEnum.PROJECT.K, format: { showProjectFullName: false, showSerialNumber: true, projectNameShowConfig: projectNameArrangementModeEnum.SERIAL_NUMBER_START.V, lineBreak: false }}, { show: true, source: dataSourceEnum.SYSTEM.V, key: 'monomer', title: '单体：', width: 165, type: typeEnum.MONOMER_NAME.K },
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'type', title: '类别：', width: 25, type: typeEnum.ENUM.K, format: { enum: 'componentTypeEnum', key: 'L' }},
