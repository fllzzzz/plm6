...
// 库存明细
const mesMainMaterialTrackStock = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'mesMainMaterialTrackStock', // 表格类型 KEY
  name: '库存明细（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  ...
  header: {
    ...
    fields: [
      ...
      { show: true, key: 'basicName', title: '品名：', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, width: 70, type: typeEnum.STRUCTURE_NAME.K },
      { show: true, key: 'thickness', title: '厚度/规格：', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, width: 70, type: typeEnum.SPECIFICATION.K },
      { show: true, key: 'material', title: '材质：', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, width: 50, type: typeEnum.MATERIAL.K },
      {
        show: false,
  ...
  table: {
    ...
    fields: [
      ...
      },
      {
        ...
        minWidth: 18,
        type: typeEnum.ENUM.K,
        format: { enum: 'projectWarehouseTypeEnum', key: 'L' }
      },
      {
        show: true,
        key: 'warehouse.name',
...
export default {
  mesMainMaterialTrackStock // 库存明细
}
