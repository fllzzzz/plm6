...
const mesDrillProductionTaskOrder = {
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'quantity', title: '数量', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 13, type: typeEnum.OTHER.K, sum: true },
      { show: true, key: 'weight', title: '重量', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.OTHER.K, sum: true }
    ]
  }
}
