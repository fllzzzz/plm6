...
// 工单管理：部件任务清单
const mesAssembleProductionTaskOrder = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'mesAssembleProductionTaskOrder', // 表格类型 KEY
  name: '任务清单（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  ...
  table: {
     ...
     */
    fields: [
      { show: true, key: 'taskType', title: '属性', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.ENUM.K, format: { enum: 'structureOrderTypeEnum', key: 'L' }},
...
export default {
  mesAssembleProductionTaskOrder // 任务清单
}
