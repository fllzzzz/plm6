...
// 工单管理：部件套料清单
const mesAssembleNestingOrder = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'mesAssembleNestingOrder', // 表格类型 KEY
  name: '套料清单（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  ...
  header: {
    ...
    /**
         ...
         */
    fields: [ // 字段内容
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'project', title: '项目：', width: 100, type: typeEnum.PROJECT.K, format: { showProjectFullName: false, showSerialNumber: true, projectNameShowConfig: projectNameArrangementModeEnum.SERIAL_NUMBER_START.V, lineBreak: false }},
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'serialNumber', title: '任务单：', width: 50, type: typeEnum.SERIAL_NUMBER.K },
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'workshopAndLine', title: '产线：', width: 100, type: typeEnum.OTHER.K },
  ...
  table: {
    ...
    /**
         ...
         */
    fields: [
      { show: true, key: 'serialNumber', title: '套料编号', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 20, type: typeEnum.SERIAL_NUMBER.K },
      { show: true, key: 'typesettingAssembleName', title: '材料属性', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.OTHER.K },
      ...
      { show: true, key: 'lossRate', title: '损耗率', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 14, type: typeEnum.RATE.K }
    ]
  }
}

export default {
  mesAssembleNestingOrder // 套料清单
}
