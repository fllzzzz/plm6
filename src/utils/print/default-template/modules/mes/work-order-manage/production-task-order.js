...
// 工单管理：生产任务单
const mesProductionTaskOrder = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'mesProductionTaskOrder', // 表格类型 KEY
  name: '生产任务单（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  ...
  header: {
    ...
    fields: [ // 字段内容
      ...
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'artifactOrder', title: '任务单号：', width: 120, type: typeEnum.ORDER_TYPE.K },
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'name', title: '班组：', width: 70, type: typeEnum.OTHER.K },
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'serialNumber', title: '编号：', width: 120, type: typeEnum.SERIAL_NUMBER.K },
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'printDate', title: '打印时间：', width: 70, type: typeEnum.DATE.K, format: 'YY/MM/DD kk:mm:ss' },
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'shortName', title: '简称：', width: 120, type: typeEnum.OTHER.K },
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'printer', title: '打印人：', width: 70, type: typeEnum.USER_NAME.K }
    ]
  },
  /**
    * 表尾
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'totalNetWeight', title: '总净重', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.WEIGHT.K, format: { toThousand: false, precision: 3 }, sum: true },
      { show: false, key: 'grossWeight', title: '单毛重', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.WEIGHT.K },
      { show: true, key: 'totalSurfaceArea', title: '总面积', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.METE.K, format: { toThousand: false, precision: 3 }, sum: true },
      { show: true, key: 'quantity', title: '任务数', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.QUANTITY.K, sum: true },
      { show: false, key: 'completeTime', title: '完成日期', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 28, type: typeEnum.DATE.K, format: 'YYYY/MM/DD' },
      { show: true, key: 'remark', title: '备注', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 20, type: typeEnum.OTHER.K }
    ]
  }
}

export default {
  mesProductionTaskOrder // 生产任务单
}
