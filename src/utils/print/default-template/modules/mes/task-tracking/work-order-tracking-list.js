...
// 工单跟踪
const mesWorkOrderTrackingList = {
  fontUnit: 'pt', // 字体单位
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'completeQuantity', title: '完成', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 14, type: typeEnum.QUANTITY.K },
