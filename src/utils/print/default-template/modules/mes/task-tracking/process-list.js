...
const processList = {
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'unFinishQuantity', title: '未完成数', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.OTHER.K },
      ...
      { show: true, key: 'team', title: '负责班组', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 18, type: typeEnum.OTHER.K }
    ]
  }
}
