...
const structureTotalPriceDetail = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'structureTotalPriceDetail', // 表格类型 KEY
  name: `结构项目库存价值详情（平台）`, // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  paddingTB: 10, // 上下内边距
  ...
  header: {
    ...
    /**
       ...
       */
    fields: [ // 字段内容
      // { show: true, source: dataSourceEnum.SYSTEM.V, key: 'project', title: '项目：', width: 190, type: typeEnum.PROJECT.K, format: { showProjectFullName: true, showSerialNumber: true, projectNameShowConfig: projectNameArrangementModeEnum.SERIAL_NUMBER_START.V }},
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'workshopName', title: '部门', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 10, type: typeEnum.STRUCTURE_NAME.K },
      ...
      { show: true, key: 'material', title: '材质', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 10, type: typeEnum.MATERIAL.K },
      { show: true, key: 'quantity', title: '数量', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 12, type: typeEnum.QUANTITY.K, sum: true },
      { show: true, key: 'netWeight', title: '单净重(kg)', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 12, type: typeEnum.WEIGHT.K, sum: true },
      { show: true, key: 'grossWeight', title: '单毛重(kg)', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 12, type: typeEnum.WEIGHT.K, sum: true },
      { show: true, key: 'totalNetWeight', title: '总净重(kg)', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 12, type: typeEnum.WEIGHT.K, sum: true },
      { show: true, key: 'totalGrossWeight', title: '总毛重(kg)', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 12, type: typeEnum.WEIGHT.K, sum: true },
      { show: true, key: 'totalPrice', title: '价值(元)', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 10, type: typeEnum.AMOUNT.K, sum: true }
...
// export default {
//   structureFinishedGoodsInventoryDetail // 制成品入发存详情
// }

export default {
  structureTotalPriceDetail
}
