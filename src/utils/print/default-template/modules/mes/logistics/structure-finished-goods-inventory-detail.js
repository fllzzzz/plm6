...
const structureFinishedGoodsInventoryDetail = ({ tableName, type }) => {
  return {
    ...
    table: {
      ...
      fields: [
        ...
        { show: true, key: 'quantity', title: '数量', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 14, type: typeEnum.QUANTITY.K, sum: true },
