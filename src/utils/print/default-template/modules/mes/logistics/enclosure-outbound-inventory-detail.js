...
// 发运管理-围护制成品入发存/出库量
const enclosureOutboundInventoryDetail = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'enclosureOutboundInventoryDetail', // 表格类型 KEY
  name: '出库量明细（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'quantity', title: '出库数（件）', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 10, type: typeEnum.QUANTITY.K, sum: true },
      { show: true, key: 'totalLength', title: '出库量（mm）', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 14, type: typeEnum.LENGTH.K, sum: true },
...
export default {
  enclosureOutboundInventoryDetail // 围护制成品入发存
}
