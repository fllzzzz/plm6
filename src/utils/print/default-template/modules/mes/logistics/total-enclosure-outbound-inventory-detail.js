...
// 发运管理-围护制成品入发存出库库存详情
const enclosureTotalOutboundInventoryDetail = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'enclosureTotalOutboundInventoryDetail', // 表格类型 KEY
  name: '围护制成品出库库存详情（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  paddingTB: 10, // 上下内边距
  ...
  table: {
     ...
     */
    th: { size: 10, bold: 'bold', lineHeight: 22, paddingTB: 1 },
    /**
     * td
     * @param {number} size 字体大小
     * @param {string} bold 是否加粗 'unset' || 'bold'
     * @param {number} lineHeight 行高
     */
    td: { size: 9, bold: 'unset', lineHeight: 22, paddingTB: 1 },
    ...
    fields: [
      ...
      { show: true, key: 'totalLength', title: '出库量（m）', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 14, type: typeEnum.LENGTH.K, format: { toThousand: false, precision: 3, unit: lengthUnitEnum.M.V }, sum: true }
...
export default {
  enclosureTotalOutboundInventoryDetail // 围护制成品入发存
}
