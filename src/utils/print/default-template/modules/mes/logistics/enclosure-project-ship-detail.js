...
// 发运管理-围护项目发运详情
const enclosureProjectShipDetail = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'enclosureProjectShipDetail', // 表格类型 KEY
  name: '围护项目发运详情（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  paddingTB: 10, // 上下内边距
  ...
  header: {
     ...
     */
    fields: [ // 字段内容
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'projectName', title: '项目名称：', align: alignEnum.LEFT.V, width: 90, type: typeEnum.OTHER.K },
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'cargoTotalLength', title: '发运总长(m)', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 14, type: typeEnum.LENGTH.K, format: { toThousand: false, precision: 3, unit: lengthUnitEnum.M.V }, sum: true }
    ]
  }
}
