...
const mesWageDetail = {
  ...
  header: {
     ...
     */
    fields: [ // 字段内容
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'name', title: '班组：', width: 82, type: typeEnum.TEAM_NAME.K },
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'productType', title: '产品类型：', width: 44, type: typeEnum.PRODUCT_TYPE.K },
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'completeQuantity', title: '完成数', source: dataSourceEnum.SYSTEM.V, align: alignEnum.CENTER.V, minWidth: 16, type: typeEnum.QUANTITY.K, format: { toThousand: false, precision: 0 }, sum: true },
      { show: true, key: 'completeMete', title: '完成量', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 20, type: typeEnum.OTHER.K },
      ...
      { show: true, key: 'wage', title: '工资单价', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.AMOUNT.K, format: { toThousand: true, precision: 2, unit: amountUnitEnum.YUAN.V }},
