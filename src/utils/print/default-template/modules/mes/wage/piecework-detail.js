...
// 计件详情报表
const mesPieceworkDetail = {
  fontUnit: 'pt', // 字体单位
  unit: cssUnitEnum.MM.V, // 长度单位
  unitPrecision: cssUnitPrecisionEnum.ZERO.V, // 长度单位精度
  type: 'mesPieceworkDetail', // 表格类型 KEY
  name: '计件详情报表（平台）', // 表格名称
  width: 210, // 打印纸的宽度
  height: 297, // 打印纸的高度
  paddingLR: 10, // 左右内边距
  ...
  header: {
    ...
    fields: [ // 字段内容
      ...
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'productType', title: '产品类型：', width: 64, type: typeEnum.PRODUCT_TYPE.K },
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'teamName', title: '班组：', width: 46, type: typeEnum.TEAM_NAME.K },
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'processName', title: '工序：', width: 40, type: typeEnum.COMPONENT_PROCESS.K },
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'printDate', title: '打印日期：', width: 40, type: typeEnum.DATE.K, format: 'YY/MM/DD' },
      { show: true, source: dataSourceEnum.SYSTEM.V, key: 'printer', title: '打印人：', width: 64, type: typeEnum.USER_NAME.K }
    ]
  },
  /**
    * 表尾
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'checkMete', title: '核算量', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 20, type: typeEnum.OTHER.K },
