...
const mesStructureProductionStatisticsUn = {
  ...
  table: {
    ...
    fields: [
      ...
      { show: true, key: 'unProductionNetWeight', title: '未生产总量', source: dataSourceEnum.SYSTEM.V, align: alignEnum.RIGHT.V, minWidth: 18, type: typeEnum.WEIGHT.K, format: { toThousand: false, precision: 3, unit: weightUnitEnum.G.V }, sum: true }
    ]
  }
}
