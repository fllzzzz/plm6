...
export default {
  ...
  methods: {
    ...
    async init() {
      ...
      if (!checkPermission(this.permission.get)) {
        return
      }
      return new Promise((resolve, reject) => {
        ...
        //   reject(err)
        // })
        this.crudMethod.get(this.getQueryParams()).then(data => {
          this.emptyText = '暂无数据'
    ...
    getQueryParams: function () {
      return {
        page: this.hasPagination ? this.page : undefined,
        size: this.hasPagination ? this.size : undefined,
        // sort: this.sort,
        ...this.query,
        ...this.params
      }
