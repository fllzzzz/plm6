import { purchaseOrderPaymentModeEnum, orderSupplyTypeEnum, baseMaterialTypeEnum, materialFreezeTypeEnum } from '@enum-ms/wms'
...
const getPendingReviewIdList = {
  url: '/api/wms/reject/application/review/raw-materials/pending/ids',
  method: 'get',
  timeout: 500,
  response: () => {
    return {
...
// 审核通过
const reviewPassed = {
  url: '/api/wms/reject/application/review/raw-materials/passed',
  method: 'put',
  timeout: 500,
  response: () => {
    return {
...
const reviewReturned = {
  url: '/api/wms/reject/application/review/raw-materials/returned',
  method: 'put',
  timeout: 500,
  response: () => {
    return {
...
// 退货申请列表
const get = {
  url: '/api/wms/reject/application/review/raw-materials',
  method: 'get',
  timeout: 1000,
  response: () => {
    return {
...
// 钢材详情
const detail_id1 = {
  url: '/api/wms/reject/application/review/raw-materials/1',
  method: 'get',
  timeout: 1000,
  response: () => {
    return {
...
// 气体详情
const detail_id2 = {
  url: '/api/wms/reject/application/review/raw-materials/2',
  method: 'get',
  timeout: 1000,
  response: () => {
    return {
...
// 辅材详情
const detail_id3 = {
  url: '/api/wms/reject/application/review/raw-materials/3',
  method: 'get',
  timeout: 1000,
  response: () => {
    return {
...
export default [getPendingReviewIdList, reviewPassed, reviewReturned, get, edit, del, detail_id1, detail_id2, detail_id3]
